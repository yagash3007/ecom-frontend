            ...
            <SimpleSlider settings={settings} selector={sliderRef}>
              <div className="item w-full xl:h-[733px] h-[500px]">
                <div
                  ...
                  style={{
                    backgroundImage: `https://static.vecteezy.com/system/resources/previews/002/288/676/non_2x/women-in-fashion-banner-sale-discount-free-vector.jpg`,
              ...
              <div className="item w-full xl:h-[733px] h-[500px]">
                <div
                  className="relative w-full h-full md:bg-center"
                  style={{
                    backgroundImage: `https://img.freepik.com/premium-psd/black-friday-massive-sale-social-media-facebook-cover-template_233825-99.jpg?w=826`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                  }}
                >
