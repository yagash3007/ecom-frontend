...
export default function Faq() {
  return (
    <Layout childrenClasses="pt-0 pb-0">
      <div className="w-full mb-10 faq-page-wrapper">
        <div className="w-full page-title">
          <PageTitle
      ...
      <div className="w-full mb-10 contact-wrapper">
...
humour, or randomised words"
            ...
            <div className="flex-1">
              <div className="p-5 bg-white sm:p-10">
