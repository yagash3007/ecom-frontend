...
export default function Banner({ className }) {
  ...
  return (
    <>
      ...
      >
        <div className="w-full h-full main-wrapper">
          <div className="relative w-full mb-20 xl:h-full xl:mb-0">
            <SimpleSlider settings={settings} selector={sliderRef}>
              <div className="item w-full xl:h-[733px] h-[500px]">
                <div
                  className="relative w-full h-full md:bg-center"
                  style={{
                    backgroundImage: `url('https://ishoes.com.au/cdn/shop/files/ishoes_1400x.png?v=1695869147')`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                    backgroundPosition: "center",
                    backgroundPosition: "center top",
                    maxWidth: "100%", // Corrected camelCase
                    height: "80vh",
                    aspectRatio: "1920 / 631", // Maintains aspect ratio // maintains aspect ratio
                  }}
                >
                  <div className="flex items-center h-full mx-auto container-x">
                    <div className="items-center w-full h-full pt-20 xl:flex xl:pt-0">
              ...
              <div className="item w-full xl:h-[733px] h-[500px]">
                <div
                  className="relative w-full h-full md:bg-center"
                  style={{
                    backgroundImage: `url('https://cdn.shopify.com/s/files/1/0692/9773/3934/files/SS23_Gibbs_-_New_Arrivals_Slideshow_Desktop_1920x.jpg?v=1678788780')`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                  }}
                >
              ...
              <div className="item w-full xl:h-[733px] h-[500px]">
                <div
                  className="relative w-full h-full md:bg-center"
                  style={{
                    backgroundImage: `url('https://i.pinimg.com/originals/b8/ce/12/b8ce12af4e594bcb26b8f55b0377dad4.jpg')`,
                    backgroundRepeat: "no-repeat",
                    backgroundSize: "cover",
                  }}
                >
          ...
          <div className="item">
            <div className="flex items-center space-x-5">
              ...
              <div>
                ...
                <p className="text-sm text-white text-qgray">
