...
export default function ProductCardStyleOneTwo({ datas }) {
  return (
    <div
      className="relative w-full h-full overflow-hidden bg-white product-card-style-one-two group"
    ...
    >
      ...
      <div className="product-card-details flex justify-center h-[102px] items-center  relative">
        {/* add to card button */}
        <div className="absolute w-full h-[364px] left-[80px] -bottom-20 group-hover:bottom-[65px] transition-all duration-300 ease-in-out">
