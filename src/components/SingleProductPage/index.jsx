...
export default function SingleProductPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const fetchedProducts = await getProductById(product_id);
    ...
    <>
      <div className="single-product-page">
        <Layout childrenClasses="pt-0 pb-0">
          <div className="w-full single-product-wrapper ">
            <div className="product-view-main-wrapper bg-white pt-[30px] w-full">
              <div className="w-full breadcrumb-wrapper ">
            ...
            <div
              ...
              ref={reviewElement}
            >
              {/* <div className="w-full mt-5 mb-10 tab-buttons sm:mt-0">
                <div className="mx-auto container-x">
                  ...
                  {tab === "des" && (
                    <div data-aos="fade-up" className="w-full tab-content-item">
                      ...
                      <p className="text-[15px] text-qgray text-normal mb-10">
                        ...
                        survived not only five centuries but also the on leap
                        into electronic typesetting, remaining essentially
                        unchanged. It wasn’t popularised in the 1960s with the
                      ...
                      <div>
                        ...
                        <ul className="list-disc ml-[15px]">
                          <li className="font-normal leading-9 text-qgray">
                            slim body with metal cover
                          </li>
                          <li className="font-normal leading-9 text-qgray">
                            latest Intel Core i5-1135G7 import.metaor (4 cores /
                            8 threads)
                          </li>
                          <li className="font-normal leading-9 text-qgray">
            ...
            {/* <div className="w-full bg-white related-product">
              <div className="mx-auto container-x">
                ...
                <div className="w-full inputs">
                  ...
                  <div className="w-full mb-[40px]">
                    ...
                    <textarea
                      ...
                      cols="30"
                      rows="6"
                      className="w-full px-4 py-3 text-sm border focus:ring-0 focus:outline-none border-qgray-border placeholder:text-sm"
