...
import { handleAddToCart } from "../Helpers/HandleFunctions/handleAddCart";

export default function ProductView({ className, reportHandler, data }) {
  console.log("ajksodjaosdijaiopdj", data);

  const [src, setSrc] = useState(data.imageUrls[0]);
    ...
    >
      ...
      <div className="flex-1">
        <div className="w-full mt-10 product-details lg:mt-0">
          ...
          <div data-aos="fade-up" className="flex items-center space-x-2 mb-7">
            {/* <span className="mt-2 text-sm line-through font-500 text-qgray">
              {data.price}
            </span> */}
            <span className="text-2xl font-500 text-qred"> ${data.price}</span>
          </div>
          ...
          >
            ...
            <div className="flex-1 h-full">
              <button
                type="button"
                className="w-full h-full text-sm font-semibold black-btn"
                onClick={() => {
          ...
          {/* <div data-aos="fade-up" className="mb-[20px]">
            <p className="text-[13px] text-qgray leading-7">
              <span className="text-qblack">Category :</span> {data.description}
            </p>
            <p className="text-[13px] text-qgray leading-7">
