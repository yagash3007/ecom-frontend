...
export default function HeaderOne({ className, drawerAction, type = 5 }) {
  return (
    <header className={` ${className || ""} header-section-wrapper relative`}>
      <TopBar className="quomodo-shop-top-bar" />
      <Middlebar
        type={type}
        className="hidden quomodo-shop-middle-bar lg:block"
      />
      ...
      <Navbar type={type} className="hidden quomodo-shop-nav-bar lg:block" />
    </header>
  );
}
