...
export default function Footer({ type }) {
  return (
    <footer className="bg-white footer-section-wrapper print:hidden">
      <div className="container-x block mx-auto pt-[56px]">
        ...
        <div className="lg:flex justify-between mb-[50px]">
          ...
          <div className="flex-1 lg:flex">
            ...
            <div className="items-center w-full mb-10 lg:w-1/3 lg:flex lg:flex-col lg:mb-0 ">
              <div>
                <div className="mb-5">
          ...
          <div className="flex items-center justify-between mb-3 lg:space-x-5">
            ...
            <span className="sm:text-base text-[10px] text-qgray font-300">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mx-1 font-500 text-qblack"
              >
                yagash
              </a>
              All rights reserved
